package fr.esgi.ecommerce.util;
...
public class TestConstants {
    ...
    public static final String URL_PRODUCTS_BASIC = "/api/v1/products";
    public static final String URL_PRODUCTS_SEARCH = "/api/v1/products/search";
    public static final String URL_PRODUCTS_GRAPHQL = "/api/v1/products/graphql";
    ...
    public static final String GRAPHQL_QUERY_ORDERS_BY_EMAIL = "{ ordersByEmail(email: \"test123@test.com\") { id totalPrice date firstName lastName city address " +
            "email phoneNumber postIndex orderItems { id amount quantity product { id productTitle productr price filename } } } }";
    public static final String GRAPHQL_QUERY_PRODUCTS_BY_IDS = "{ productsIds(ids: [3,4,5]) { id productTitle productr price } }";
    public static final String GRAPHQL_QUERY_PRODUCTS = "{ products { id productTitle productr price filename } }";
